                ...
                <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-100">
                        <tr>
                            <th className="w-8"></th>
                            <th className="w-8"></th>
                            <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('description')}</th>
                            <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('category')}</th>
                            <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('date')}</th>
                            <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('payment_method')}</th>
                            <th className="text-right py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('amount')}</th>
                            <th className="text-right py-4 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('edit')}</th>
                        </tr>
                    </thead>
                            ...
                            return (
                                <>
                                    ...
                                    {isExpanded && group.map(transactionItem => {
                                        ...
                                        return (
                                            <tr key={transactionItem.id} className="bg-gray-50/30 hover:bg-gray-50 transition-colors">
                                                <td></td>
                                                ...
                                                <td className="py-3 px-6 text-sm text-gray-500">
                                                    ...
                                                    {(transactionItem.status === 'paid' || transactionItem.isPaid) && (
                                                        <span className="ml-2 text-[10px] text-green-500 bg-green-50 px-1.5 py-0.5 rounded">{t('paid')}</span>
                                                    )}
                                                </td>
                                                <td className="py-3 px-6 text-sm text-gray-500">
                                                    {/* Method repeated */}
