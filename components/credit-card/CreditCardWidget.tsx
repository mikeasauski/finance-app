    ...
    return (
        ...
        >
            ...
            <div className={`mt-6 pt-4 border-t border-white/10 flex justify-between text-sm ${subTextColor}`}>
                <div>
                    <p className="text-xs opacity-80">{t('closes_day')}</p>
                    <p className="font-medium">{t('day')} {card.closingDay}</p>
                </div>
                <div className="text-right">
                    <p className="text-xs opacity-80">{t('due_day')}</p>
                    <p className="font-medium">{t('day')} {card.dueDay}</p>
                </div>
            </div>
        </div>
    );
