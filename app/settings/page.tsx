        ...
        <div className="space-y-8 max-w-4xl">
            ...
            <section className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-slate-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            <span className="block font-medium text-red-900 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300">
                                {t('delete_transactions')}
                            </span>
                            <span className="text-xs text-red-600/70 dark:text-red-400/70">
                                {t('delete_transactions_desc')}
                            </span>
                        </button>
            ...
            {deleteModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-6 animate-in zoom-in-95">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full p-3 border border-gray-300 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 rounded-xl focus:ring-2 focus:ring-red-500 outline-none uppercase"
                                placeholder="DELETAR"
                            />
                        </div>
