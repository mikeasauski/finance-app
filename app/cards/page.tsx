...
import { CreditCard, Account, Document } from "@/types";
...
export default function CardsPage() {
    const { t } = useLanguage(); const { cards, transactions, accounts, removeAccount } = useFinance();
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">{t('wallet_subtitle')}</p>                </div>
                <button
                ...
                >
                    <Plus size={20} />
                    <span>{activeTab === 'cards' ? t('new_card') : activeTab === 'accounts' ? t('new_account') : t('new_document')}</span>                </button>
            </div>

            {/* Tabs */}
            <div className="flex p-1 bg-muted rounded-xl w-full max-w-md">                <button
